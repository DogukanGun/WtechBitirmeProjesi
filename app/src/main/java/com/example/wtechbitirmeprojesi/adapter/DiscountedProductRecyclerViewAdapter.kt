...
class DiscountedProductRecyclerViewAdapter(private val products:List<Product>, private val viewModel: DiscountedProductViewModel): RecyclerView.Adapter<DiscountedProductRecyclerViewAdapter.DiscountedProductsCardHolder>() {
